...
namespace WpfChartExcelExport
{
    public static class OpenXmlLiveChartsExporter
    {
            ...
            double? yMajorUnit)
        {
            ...
            GenerateChartPartContent(chartPart, worksheetName, mapped, pointCount, headerRowIndex, dataStartRowIndex, xValueCol, firstSeriesCol, chartTitle, xAxisTitle, yAxisTitle, yMin, yMax, yMajorUnit);
            ...
            double? yMajorUnit)
        {
            ...
            plotArea.Append(CreateValueAxis(xAxisId, yAxisId, xAxisTitle, C.AxisPositionValues.Bottom, false, null, null, null));
            plotArea.Append(CreateValueAxis(yAxisId, xAxisId, yAxisTitle, C.AxisPositionValues.Left, true, yMin, yMax, yMajorUnit));
            ...
            double? majorUnit)
        {
            ...
            if (maxValue.HasValue)
                scaling.Append(new C.MaxAxisValue { Val = maxValue.Value });

            if (minValue.HasValue)
                scaling.Append(new C.MinAxisValue { Val = minValue.Value });
            ...
            if (majorUnit.HasValue)
                axis.Append(new C.MajorUnit { Val = majorUnit.Value });
